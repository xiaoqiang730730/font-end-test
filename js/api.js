! function(e) {
	function t(e, t, n, r) {
		return "function" == typeof t && (r = n, n = t, t = void 0), "function" != typeof n && (r = n, n = void 0), {
			url: e,
			data: t,
			fnSuc: n,
			dataType: r
	...
	n.trim = function(e) {
		...
		return 1 === arguments.length ? e.children[0] : 2 === arguments.length ? this.dom(e, t + ":first-child") : void 0
	}, n.last = function(e, t) {
		...
		var r, o, i = function(e, t) {
				var n = 0,
					r = e.length;
				for (n; r > n; n++)
					if (e[n].isEqualNode(t)) return e[n];
				return !1
			},
			a = function(e, t) {
		...
		if (t === e) return n = !0;
		do
			if (t = t.parentNode, t === e) return n = !0;
		while (t === document.body || t === document.documentElement);
		return n
	}, n.remove = function(e) {
		e && e.parentNode && e.parentNode.removeChild(e)
	}, n.attr = function(e, t, n) {
		return 2 == arguments.length ? e.getAttribute(t) : 3 == arguments.length ? (e.setAttribute(t, n), e) : void 0
		...
		return 1 === arguments.length ? e.innerHTML : 2 === arguments.length ? (e.innerHTML = t, e) : void 0
	}, n.text = function(e, t) {
		return 1 === arguments.length ? e.textContent : 2 === arguments.length ? (e.textContent = t, e) : void 0
	}, n.offset = function(e) {
		var t, n;
		...
		if (t) {
			var n = t.getItem(e);
			if (!n) return;
			if (0 === n.indexOf("obj-")) return n = n.slice(4), JSON.parse(n);
			if (0 === n.indexOf("str-")) return n.slice(4)
		}
		...
		if ("ios" == t) {
			var n = api.systemVersion,
				r = parseInt(n, 10),
				o = api.fullScreen,
				i = api.iOS7StatusBarAppearance;
